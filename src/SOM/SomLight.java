 ...
 * 
 * */
public class SomLight extends SomGrid {
	...
	public SomLight(double[][] matrix, int xDim, int yDim, int epochs)
	{
		super(matrix);
	...
	public void train()
	{
		...
		double xDist;
		double yDist;
            for (int[] pairArray1 : this.pairArray) {
                // Set the reference point to the current row
                currentX = pairArray1[0];
                currentY = pairArray1[1];
                    for (int[] pairArray2 : this.pairArray) {
                        // Calculate the rectilinear distances from this point
                        // to the reference point
                        xDist = Math.abs(pairArray2[0] - currentX);
                        yDist = Math.abs(pairArray2[1] - currentY);
